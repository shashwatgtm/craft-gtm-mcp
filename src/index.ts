...
const server = new Server(
  { name: "craft-gtm-mcp", version: "1.0.0" },
  { capabilities: { tools: {} } }
);
...
function generatePMFScorecard(a: Record<string, string>): string {
...
function generateLaunchPlan(a: Record<string, string>): string {
...
function generateInterviewKit(a: Record<string, string>): string {
...
function generateRetentionPlaybook(a: Record<string, string>): string {
...
function generatePartnerProgram(a: Record<string, string>): string {
...
function generateCrisisResponse(a: Record<string, string>): string {
...
function generateCompetitiveIntel(a: Record<string, string>): string {
...
function analyzeCRAFT(a: Record<string, string>): string {
